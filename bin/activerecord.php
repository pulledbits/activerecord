...
$sourceSchema = \pulledbits\ActiveRecord\SQL\Meta\Schema::fromDatabaseURL($dburl);
/**
...
foreach ($sourceSchema->describeTables(new \pulledbits\ActiveRecord\SQL\Meta\Table()) as $entityTypeIdentifier => $recordClassDescription) {
